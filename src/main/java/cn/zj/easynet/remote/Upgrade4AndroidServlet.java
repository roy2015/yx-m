 ...
 *          2-无要求的全部强制升级
 */
@WebServlet(name = "upgrade4AndroidServlet", loadOnStartup = 6, urlPatterns = { "/nnl/upgrade4Android" }, asyncSupported = false)
public class Upgrade4AndroidServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        Upgrade4AndroidDto upgradeDto = new Upgrade4AndroidDto();
