...
import cn.zj.easynet.rabbitmq.complex.test.RbmqUtil;
...
public class HessionCodecFactory {
	...
	private static HessionCodecFactory instance;
	
    public synchronized static HessionCodecFactory getInstance(){
        if(instance==null){
            instance = new HessionCodecFactory();
        }
        return instance;
    }
    
    private HessionCodecFactory(){}
